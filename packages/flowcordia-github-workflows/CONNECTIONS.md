...
The store does not compile, deploy, execute, list repositories, receive webhooks, or create pull requests. Those capabilities consume its receipts and source identifiers through separate adapters.
