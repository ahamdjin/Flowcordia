...
| `GitHubProposalService` | Generated artifact store | `.flowcordia/generated/<workflow>.ts` on the deterministic proposal branch | Review and promote executable source with the visual workflow definition. | Resume verifies exact generated source; mismatches fail as proposal collisions. |
