...
| ------------------------------- | ------------------------- | ---------------------------------------------------------------------- | ---------------------------------------- |
| Studio                          | Workflow model            | Convert visual intent into a portable validated contract               | Planned                                  |
| TypeScript SDK                  | Workflow model            | Expose code-authored capabilities to the same workflow identity        | Planned                                  |
| Workflow model                  | Compiler                  | Produce deterministic Trigger.dev task artifacts                       | Planned                                  |
| Workflow model                  | GitHub repository         | Preserve history, review, ownership, and rollback                      | Planned                                  |
