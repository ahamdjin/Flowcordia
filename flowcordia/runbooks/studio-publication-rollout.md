...
8. Publish the exact draft version and verify the proposal branch contains both workflow JSON and generated task TypeScript.
...
Rollback disables Studio access. Existing proposal branches and pull requests remain auditable in GitHub; no automatic deployment or runtime drain is required.
