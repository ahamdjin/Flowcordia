...
- Support subflows, batching, parallelism, approvals, and streaming. — typed version-locked child invocation and bounded same-child batch fan-out delivered; approvals, streaming batches, mixed-child parallelism, and repository-wide call-graph validation remain
