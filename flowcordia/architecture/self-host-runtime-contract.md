...
### Database endpoint compatibility

`DATABASE_HOST` must match the direct migration URL host and port. `DATABASE_URL` may use a separate application pooler endpoint.
