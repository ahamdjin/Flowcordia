...
import { executeFlowcordiaFunctionValidationCommand } from "~/features/flowcordia/workflows/validation/commands.server";
...
export const action = dashboardAction(
  ...
  async ({ ability, context, params, request, user }) => {
    ...
    return executeFlowcordiaFunctionValidationCommand({ context, request, ability });
  }
);
