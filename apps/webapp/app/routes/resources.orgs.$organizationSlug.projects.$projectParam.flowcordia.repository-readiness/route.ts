...
import { executeFlowcordiaRepositoryReadinessCommand } from "~/features/flowcordia/workflows/readiness/commands.server";
...
export const action = dashboardAction(
  ...
  async ({ context, params, request, user }) => {
    ...
    return executeFlowcordiaRepositoryReadinessCommand({ context, request });
  }
);
