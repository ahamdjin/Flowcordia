...
import { executeFlowcordiaPreviewCommand } from "~/features/flowcordia/workflows/preview/commands.server";
...
export const action = dashboardAction(
  ...
  async ({ ability, context, params, request, user }) => {
    ...
    return executeFlowcordiaPreviewCommand({ context, request, ability });
  }
);
