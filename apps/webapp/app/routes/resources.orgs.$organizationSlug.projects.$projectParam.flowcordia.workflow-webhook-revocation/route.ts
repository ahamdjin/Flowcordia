...
import { executeFlowcordiaWebhookRevocationCommand } from "~/features/flowcordia/workflows/webhook/revocation-commands.server";
...
export const action = dashboardAction(
  ...
  async ({ ability, context, params, request, user }) => {
    ...
    return executeFlowcordiaWebhookRevocationCommand({
      context,
      request,
      ability,
      actorId: user.id,
