import { executeFlowcordiaWebhookActivationCommand } from "~/features/flowcordia/workflows/webhook/activation-commands.server";
...
export const action = dashboardAction(
  ...
  async ({ ability, context, params, request, user }) => {
    ...
    return executeFlowcordiaWebhookActivationCommand({ context, request, ability });
  }
);
