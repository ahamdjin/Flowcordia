...
import { executeFlowcordiaProductionCommand } from "~/features/flowcordia/workflows/production/commands.server";
...
export const action = dashboardAction(
  ...
  async ({ ability, context, params, request, user }) => {
    ...
    return executeFlowcordiaProductionCommand({ context, request, ability });
  }
);
