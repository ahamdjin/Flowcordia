import { executeFlowcordiaOperationsHealthCommand } from "~/features/flowcordia/operations/commands.server";
...
export const action = dashboardAction(
  ...
  async ({ context, params, request, user }) => {
    ...
    return executeFlowcordiaOperationsHealthCommand({ context, request });
  }
);
