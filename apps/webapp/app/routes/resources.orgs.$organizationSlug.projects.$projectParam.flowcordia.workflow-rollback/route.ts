...
import { executeFlowcordiaRollbackCommand } from "~/features/flowcordia/workflows/rollback/commands.server";
...
export const action = dashboardAction(
  ...
  async ({ context, params, request, user }) => {
    ...
    return executeFlowcordiaRollbackCommand({ context, request, userId: user.id });
  }
);
