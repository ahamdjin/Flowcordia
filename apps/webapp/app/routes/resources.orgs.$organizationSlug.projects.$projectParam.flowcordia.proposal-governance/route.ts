import { executeFlowcordiaProposalGovernanceCommand } from "~/features/flowcordia/proposals/governance/commands.server";
...
export const action = dashboardAction(
  ...
  async ({ context, params, request, user }) => {
    ...
    return executeFlowcordiaProposalGovernanceCommand({
      context,
      request,
      userId: user.id,
    });
