 ...
 */
export type StudioV2ClientWorkspaceProjection = SerializeFrom<StudioV2WorkspaceProjection>;

export type StudioV2ClientReleaseProjection = SerializeFrom<StudioV2ReleaseProjection>;
